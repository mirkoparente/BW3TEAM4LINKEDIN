...
export class CardPrincipaleService {
  ...
  private apiUrl: string = 'https://striveschool-api.herokuapp.com/api/profile/me';
  private apiUrlProfile: string = 'https://striveschool-api.herokuapp.com/api/profile/';
